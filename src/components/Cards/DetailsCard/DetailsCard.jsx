    ...
    <div className="flex justify-center">
        <div>
            <div className="relative">
                ...
                <button className="bg-blue-600 px-4 lg:px-6 py-2 lg:py-4 rounded-lg hover:bg-blue-400 font-semibold lg:text-xl text-white absolute bottom-5 md:bottom-8 lg:bottom-14 left-10 md:left-14 lg:left-20">Donate ${price}</button>
            </div>
            <div className="text-center lg:text-left">
                <h2 className="font-bold text-2xl lg:text-4xl text-black mt-8">{title}</h2>
                <p className="w-11/12 lg:w-full text-gray-600 lg:text-lg mt-4 text-center lg:text-justify mx-auto lg:mx-0">{description}</p>
            </div>
        </div>
    </div>
  );
